...
public class OuterTest {
	...
	private static void testBalancedTree7() {
		...
		AVLTree<Integer> balanced = new AVLTree<>();
		Integer nums[] = { 63, 22, 78, 16, 28, 65, 85, 7, 21, 25, 51, 64, 72, 82, 92, 3, 13, 27, 31, 55, 69, 79, 83, 86,
				33 };
		...
		List<Integer> ansList = Arrays.asList(
				new Integer[] { 63, 22, 16, 7, 3, 13, 21, 25, 27, 31, 33, 55, 64, 69, 72, 79, 83, 86, 92, 85, 78 });
