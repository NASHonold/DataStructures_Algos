...
public class BinaryTree<T> {
    ...
    public String preorderToSting(){
        StringBuffer sb = new StringBuffer();
        sb.append("{ ");
        preorderToSting(sb,root);
        sb.append(" }");

        return sb.toString();
    }

    private void preorderToSting(StringBuffer sb, Node current){
        if(current != null){
            ...
            preorderToSting(sb,current.leftChild);
            if(current.rightChild != null){
                sb.append(", ");
            }
            
            preorderToSting(sb,current.rightChild);
        }
    }
